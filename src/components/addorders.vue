        ...
        <el-col>
          <el-form ref="form" :model="form" :rules="rules" label-width="110px" :inline="true">
            ...
            <el-form-item label="付款方式" prop="payType">
              ...
              <el-select v-model="form.payType" placeholder="选择付款方式" class="select" @change="select">
                <el-option
...
export default {
    ...
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          let pomain = {poId:this.form.poId,venderCode:
                this.form.venderCode,account:this.form.account,createTime:this.form.createTime,tipFee:this.form.tipFee,productTotal:this.form.productTotal,poTotal:this.form.poTotal,payType:this.form.payType,prePayFee:this.form.prePayFee,status:status,remark:this.form.remark,poitems:this.poitems}
          axios({
  ...
  created: function() {
    ...
    var hours = padaDate(date.getHours()); //时
    ...
    this.form.createTime =
      ...
      ":" +
      seconds; //创建时间
    this.form.poId = year + month + day + hours + minutes + seconds;
    this.form.account = store.state.account;
  }
};
</script>
