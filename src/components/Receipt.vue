      ...
      >
        ...
        <el-table-column label="操作">
          <template slot-scope="scope" class="btnmini">
            <el-button size="mini" @click="handleEdit(scope.$index, scope.row)" type="primary">收款</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
...
console.log(row);
  ...
  if (row.payType == 1) {
    ...
    pay(tab, event) {
      ...
      if (tab.label == "货到付款") {
        axios
          .post(`/api/main/sell/somain/show`, `type=4&payType=1`)
          .then(resp => {
        ...
        axios
          .post(`/api/main/sell/somain/show`, `type=4&payType=2`)
          .then(resp => {
        ...
        axios
          .post(`/api/main/sell/somain/show`, `type=4&payType=3`)
          .then(resp => {
